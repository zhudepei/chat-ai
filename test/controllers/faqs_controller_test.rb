...
class FaqsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faq" do
    assert_difference("Faq.count") do
      post faqs_url, params: { faq: { answer: @faq.answer, category: @faq.category, question: @faq.question } }, as: :json
    end
  ...
  test "should update faq" do
    patch faq_url(@faq), params: { faq: { answer: @faq.answer, category: @faq.category, question: @faq.question } }, as: :json
    assert_response :success
  end
